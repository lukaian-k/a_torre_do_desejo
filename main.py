...
def walk_up():
    ...
    if (mapas.mapa_atual == 1):
        frame = walk_main(janela, lista_objetos, 90, 10, gif_walk_default_number[0], 4, './move/up/mapa1/up', teclas_on, teclas_off, mapas)
    elif (mapas.mapa_atual == 2):
        frame = walk_main(janela, lista_objetos, 90, 10, gif_walk_default_number[0], 4, './move/up/mapa2/up', teclas_on, teclas_off, mapas)
    elif (mapas.mapa_atual == 3):
        frame = walk_main(janela, lista_objetos, 90, 10, gif_walk_default_number[0], 4, './move/up/mapa3/up', teclas_on, teclas_off, mapas)
...
def walk_down():
    ...
    if (mapas.mapa_atual == 1):
        frame = walk_main(janela, lista_objetos, 270, 10, gif_walk_default_number[1], 4, './move/down/mapa1/down', teclas_on, teclas_off, mapas)
    elif (mapas.mapa_atual == 2):
        frame = walk_main(janela, lista_objetos, 270, 10, gif_walk_default_number[1], 4, './move/down/mapa2/down', teclas_on, teclas_off, mapas)
    elif (mapas.mapa_atual == 3):
        frame = walk_main(janela, lista_objetos, 270, 10, gif_walk_default_number[1], 4, './move/down/mapa3/down', teclas_on, teclas_off, mapas)
...
def walk_right():
    ...
    if (mapas.mapa_atual == 1):
        frame = walk_main(janela, lista_objetos, 0, 10, gif_walk_default_number[2], 6, './move/right/mapa1/right', teclas_on, teclas_off, mapas)
    elif (mapas.mapa_atual == 2):
        frame = walk_main(janela, lista_objetos, 0, 10, gif_walk_default_number[2], 6, './move/right/mapa2/right', teclas_on, teclas_off, mapas)
    elif (mapas.mapa_atual == 3):
        frame = walk_main(janela, lista_objetos, 0, 10, gif_walk_default_number[2], 6, './move/right/mapa3/right', teclas_on, teclas_off, mapas)
...
def walk_left():
    ...
    if (mapas.mapa_atual == 1):
        frame = walk_main(janela, lista_objetos, 180, 10, gif_walk_default_number[3], 6, './move/left/mapa1/left', teclas_on, teclas_off, mapas)
    elif (mapas.mapa_atual == 2):
        frame = walk_main(janela, lista_objetos, 180, 10, gif_walk_default_number[3], 6, './move/left/mapa2/left', teclas_on, teclas_off, mapas)
    elif (mapas.mapa_atual == 3):
        frame = walk_main(janela, lista_objetos, 180, 10, gif_walk_default_number[3], 6, './move/left/mapa3/left', teclas_on, teclas_off, mapas)
...
def chamando_estatua():
    #Criando algumas variaveis para guarda as posicoes dos objetos
    pos_player = nessa.pos(); pos_estatua = estatua.pos()
    
    #Se caso o atributo que permite a estatua continuarem a se mover for true o laco comeca
    if (estatua.ontimer_continuar == True):
        #Checa se o estatua pode continuar
        if (estatua.ontimer_continuar == True and mapas.inimigos_quantidade['estatua'] >= 1):
            estatua.showturtle()
            if (acao_estatua(janela, estatua, nessa, collision_enemy_projectiles) == True):
...
def chamando_demonio():
    ...
    if (demonio_um.ontimer_continuar == True or demonio_dois.ontimer_continuar == True):
...
class mapas():
    ...
    def mapa_dois():
        ...
        lista_inimigos['estatua'].setpos(11, 66)
...
nessa.arrow.ataque = True; nessa.arrow.voador = False; nessa.arrow.distancia = 0 #Cria alguns atributos
...
demonio_um.frame = 1; demonio_um.vida = enemy_list['demonio1']['vida']; demonio_um.tamanho = [143, 143, 103, 0]; demonio_um.ontimer_continuar = True; demonio_um.voador = False #Cria alguns atributos
#Criando o demonio2
